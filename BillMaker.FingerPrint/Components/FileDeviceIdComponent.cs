...
{
    /// <summary>
    /// An implementation of <see cref="IFingerPrintComponent"/> that retrieves its value from a file.
    /// </summary>
    public class FileFingerPrintComponent : IFingerPrintComponent
    {
        /// <summary>
        ...
        public FileFingerPrintComponent(string name, string path, bool shouldHashContents = false)
        ...
        /// <param name="shouldHashContents">Whether the file contents should be hashed.</param>
        public FileFingerPrintComponent(string name, IEnumerable<string> paths, bool shouldHashContents = false)
        {
            Name = name;
