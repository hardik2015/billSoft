...
{
    /// <summary>
    /// An implementation of <see cref="IFingerPrintComponent"/> that retrieves data from installed network adapaters.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class NetworkAdapterFingerPrintComponent : IFingerPrintComponent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkAdapterFingerPrintComponent"/> class.
        /// </summary>
        ...
        /// </remarks>
        public NetworkAdapterFingerPrintComponent(bool excludeNonPhysical, bool excludeWireless)
        {
