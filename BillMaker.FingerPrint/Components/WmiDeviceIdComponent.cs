...
{
    /// <summary>
    /// An implementation of <see cref="IFingerPrintComponent"/> that retrieves data from a WMI class.
    /// </summary>
    public class WmiFingerPrintComponent : IFingerPrintComponent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WmiFingerPrintComponent"/> class.
        /// </summary>
        /// <param name="name">The name of the component.</param>
        /// <param name="wmiClass">The WMI class name.</param>
        /// <param name="wmiProperty">The WMI property name.</param>
        public WmiFingerPrintComponent(string name, string wmiClass, string wmiProperty)
        {
            Name = name;
            _wmiClass = wmiClass;
