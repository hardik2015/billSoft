...
{
    /// <summary>
    /// An implementation of <see cref="IFingerPrintComponent"/> that uses the root drive's serial number.
    /// </summary>
    public class LinuxRootDriveSerialNumberFingerPrintComponent : IFingerPrintComponent
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinuxRootDriveSerialNumberFingerPrintComponent"/> class.
        /// </summary>
        public LinuxRootDriveSerialNumberFingerPrintComponent()
        ...
        internal LinuxRootDriveSerialNumberFingerPrintComponent(ICommandExecutor commandExecutor)
        {
